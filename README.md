...
Based on work from [EmilianaVT's OpenSeeFace project](https://github.com/emilianavt/OpenSeeFace), this is a currently editor-only tool for Vtubing.  
A build will be released when I get around to working on VRM importing, but until then it can be done manually in-engine.  
